...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFudWFyb3JhIiwiYSI6ImNrYmF1OHc0MzByY2wyeG84aW9ibGhkaWEifQ.QyJLhgpHCc3fTXX_o9MWuQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/manuarora/ckbaudevn00w51itat43mxmag',
    scrollZoom: false // center: [75.7873, 26.9124],
    // zoom: 4
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends map bounds to include the current locatrion
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe'; // console.log(type);
...
var stripe = Stripe('pk_test_51GugM2JJQ3V4II3vZQCLdi2rT2Qd6tEyZfE5BpLIs5eAzMcBl1JAcN6dADgFGWo40PnwDwdLZxRKFYSCH43xur3z00o04chBjB');
...
var searchForm = document.querySelector('.search-form'); // Values

console.log('Search Form', searchForm); // Delegation
...
if (searchForm) {
  ...
  searchForm.addEventListener('submit', function (e) {
    var searchTerm = document.getElementById('search-term').value; // const password = document.getElementById('password').value;
